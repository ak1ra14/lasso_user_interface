import os, socket, threading, time, subprocess, configparser, re
from kivy.clock import Clock
from kivy.logger import Logger


from as_utils.as_config_loader import load_config, save_config, update_text_language
from as_screens.as_monitor import get_ip_address
from as_screens.as_wifi import get_connected_wifi
...
class ConnectionManager:
    ...
    def _update_connection_status(self, is_connected, ssid, ip_address):
        ...
        try:
            ...
            menu_screen.content_buttons['wi-fi'].image.source = "as_images/wifi.png" if config['wifi_ssid'] != 'Not connected' else "as_images/wifi_not_connected.png"
