...
from as_utils.as_config_loader import load_config, update_text_language
        ...
        try:
            if not self.keyboard.language_button and App.get_running_app().language == 'jp':
                self.keyboard.language_button = LanguageTextButton(
                    icon_path='as_images/japanese.png',
                    size_hint=(None, None),
                    size=(110, 110),
...
class QwertyKeyboard(FloatLayout):
    ...
    def build_qwerty_keyboard(self):
        ...
        for row, subrow, shift_row in zip(self.keys, self.subkeys, self.shift_keys):
            ...
            for key, sub_key, shift_key in zip(row, subrow, shift_row):
                btn = None
                if key == 'Shift':
                    btn = RoundedButton(text='', sub_key=sub_key, image=f'as_images/shift.png', font_size=24, font_name='as_fonts/Roboto-Bold.ttf',
                                        background_color = (0.22, 0.45, 0.91, 1), size_hint_x=None, width=key_width*1.54,
                                        function='Shift',  shift_key='')
                elif key == 'English':
                    btn = RoundedButton(text='', sub_key=sub_key, image=f'as_images/switch.png', font_size=24, font_name='as_fonts/Roboto-Bold.ttf',
                                        background_color=(0.22, 0.45, 0.91, 1), size_hint_x=None, width=key_width*1.54,
                                        function='English',  shift_key='')
                elif key == 'Backspace':
                    btn = RoundedButton(text='', sub_key=sub_key, image='as_images/backspace.png', font_size=24, font_name='as_fonts/Roboto-Bold.ttf',
                                        background_color=(0.22, 0.45, 0.91, 1), size_hint_x=None, width=key_width*1.54,
                                        function='Backspace',  shift_key='')
                elif key == 'Enter':
                    btn = RoundedButton(text='', sub_key=sub_key, image='as_images/enter.png', font_size=24, font_name='as_fonts/Roboto-Bold.ttf',
                                        background_color=(0.22, 0.45, 0.91, 1), size_hint_x=None, width=key_width*1.54,
                                        function='Enter',  shift_key='',on_press=self.press_enter)
                elif key == 'Space':
                    btn = RoundedButton(text='', sub_key=sub_key,  font_size=24, font_name='as_fonts/Roboto-Bold.ttf',
                                        size_hint_x=None, width=key_width*5.35,
                                        function='Space',  shift_key='')
                else:
                    btn = RoundedButton(text=key, sub_key=sub_key, font_size=24, font_name='as_fonts/Roboto-Bold.ttf',
    ...
    def build_japanese_keyboard(self):
        ...
        for row, subrow in zip(self.japanese_keys, self.japanese_subkeys):
            ...
            for key, sub_key in zip(row, subrow):
                btn = None
                if key == 'Japanese':
                    btn = RoundedButton(text='', sub_key=sub_key, image=f'as_images/switch.png', font_size=24, font_name='as_fonts/MPLUS1p-Regular.ttf',
                    ...
                    btn = RoundedButton(text='', sub_key=sub_key, image='as_images/enter.png', font_size=24, font_name='as_fonts/MPLUS1p-Regular.ttf',
                                        background_color=(0.22, 0.45, 0.91, 1), size_hint_x=None, width=key_width*1.5,
                                        function='Enter', on_press=self.press_enter)
                elif key == 'Space':
                    btn = RoundedButton(text='空白', sub_key=sub_key,  font_size=22, font_name='as_fonts/MPLUS1p-Regular.ttf',
                                        size_hint_x=None, width=key_width*1.5, background_color=(0.22, 0.45, 0.91, 1),
                                        function='Space')
                    self.japanese_space_button = btn
                elif key == 'Daku-on':
                    btn = RoundedButton(text='', sub_key=sub_key, image='as_images/daku-on.png', font_size=24, font_name='as_fonts/Roboto-Bold.ttf',
                                        background_color=(0.22, 0.45, 0.91, 1), size_hint_x=None, width=key_width*1.5,
                                        function='Daku-on',  shift_key='')
                else:
                    btn = RoundedButton(text=key, sub_key=sub_key, font_size=24, font_name='as_fonts/MPLUS1p-Regular.ttf',
        ...
        for mapping in self.flick_mappings:
            if len(mapping) == 5 and type(mapping[0]) is str:
                ...
                if mapping[0] == 'Backspace':
                    btn = RoundedButton(
                        text='', sub_key='', image='as_images/backspace.png', font_size=24, font_name='as_fonts/MPLUS1p-Regular.ttf',
                        size_hint=(None, None), size=(120, 90), function='Backspace'
                    )
                elif mapping[0] == 'Enter':
                    btn = RoundedButton(
                        text='', sub_key='', image='as_images/enter.png', font_size=24, font_name='as_fonts/MPLUS1p-Regular.ttf',
                        size_hint=(None, None), size=(120, 90), function='Enter', on_press=self.press_enter
                    )
                elif mapping[0] == 'Space':
                    btn = RoundedButton(
                        text='空白', sub_key='', font_size=24, font_name='as_fonts/MPLUS1p-Regular.ttf',
                        size_hint=(None, None), size=(120, 90), function='Space'
                    )
                    self.flick_space_button = btn
                elif mapping[0] == 'Daku-on':
                    btn = RoundedButton(
                        text='', sub_key='', image='as_images/daku-on.png', font_size=24, font_name='as_fonts/MPLUS1p-Regular.ttf',
                        size_hint=(None, None), size=(90, 90), function='Daku-on'
                    )
                elif mapping[0] == 'Flick':
                    btn = RoundedButton(
                        text='', sub_key='', image='as_images/switch.png', font_size=24, font_name='as_fonts/MPLUS1p-Regular.ttf',
    ...
    def on_key_release(self, instance):
        ...
        self.cursor_pos = self.text_input.cursor_index()
        self.text_input.bind(text=self.limit_text_length)

        if hasattr(instance, 'mappings'):
            self.handle_flick_key(instance)
        elif instance.function == 'Space':
            self.handle_space_key(instance)
        elif instance.function == 'Backspace':
            self.handle_backspace_key(instance)
        elif instance.function == "Shift":
            self.handle_shift_key(instance)
        elif instance.function == "Japanese":
            self.handle_japanese_key(instance)
        elif instance.function == "English":
            self.handle_english_key(instance)
        elif instance.function == "Enter":
            self.handle_enter_key(instance)
        elif instance.function == 'Flick':
            self.handle_flick_mode_key(instance)
        elif instance.function == "Daku-on":
            self.handle_dakuon_key(instance)
        else:
            self.handle_character_key(instance)

    def handle_flick_key(self, instance):
        ti = self.text_input
        now = time.time()
        if self.selected_flick_mappings == instance.mappings and (now - self.last_click_time) < 1.0 and instance.idx == 0:
            ...
            if self.converting or ti.cursor_index() != self.last_cursor_index:
                ...
                self.start_index = self.cursor_pos
    ...
    def handle_space_key(self, instance):
        ti = self.text_input
    ...
    def handle_backspace_key(self, instance):
        ti = self.text_input
        self.japanese_space_button.text = '空白'
        self.flick_space_button.text = '空白'
    ...
    def handle_shift_key(self, instance):
        for btn in self.english_buttons:
            btn.update_shift_text()

    def handle_japanese_key(self, instance):
    ...
    def handle_english_key(self, instance):
    ...
    def handle_enter_key(self, instance):
        pass  # No logic provided in original

    def handle_flick_mode_key(self, instance):
    ...
    def handle_dakuon_key(self, instance):
        ti = self.text_input
        try:
    ...
    def handle_character_key(self, instance):
        ti = self.text_input
...
class LanguageTextButton(IconTextButton):
    def on_release(self):
        ...
        if self.parent.parent.keyboard_mode[self.parent.parent.keyboard_index] == 'japanese':
            ...
            self.image.source = 'as_images/japanese.png'
            ...
            self.image.source = 'as_images/english.png'


class RoundedButton(Button):
    '''
    A custom button with rounded corners, optional image, sub-key display, and long-press functionality.'''
    def __init__(self, text = None,sub_key = None, shift_key = None,function = None, image = None, background_color = (0.2, 0.2, 0.2, 1), font_name='as_fonts/Roboto-Regular.ttf', **kwargs):
...
def show_saved_popup(text='saved'):
    ...
    content.add_widget(Label(text=update_text_language(text), font_name="as_fonts/MPLUS1p-Regular.ttf", font_size=24))
