...
from as_utils.as_config_loader import load_config, save_config, update_current_page, update_text_language, save_config_partial
...
class VolumeScreen(SafeScreen):
    def __init__(self, **kwargs):
        ...
        self.volume = load_config('as_config/settings.json', 'v3_json').get('volume', 50)
        ...
        buttons.add_widget(ChangeVolume(icon_path="as_images/decrease_10.png",
        ...
        buttons.add_widget(ChangeVolume(icon_path="as_images/increase.png", 
                                        volume_label=self.volume_label, 
...
class SaveButton(IconTextButton):
    ...
    def on_press(self):
        ...
        save_config_partial("as_config/settings.json", "v3_json", key = 'volume', value=self.volume_screen.volume)
