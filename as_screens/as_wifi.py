...
from as_utils.as_layout import HeaderBar, SafeScreen, LoadingCircle
...
class WifiLoadingScreen(SafeScreen):
    ...
    def __init__(self, **kwargs):
        ...
        self.scanning = Label(text=update_text_language('scanning_wifi'), font_size=30, size_hint=(1, 0.2), 
                              pos_hint={'center_x': 0.5, 'center_y': 0.4}, font_name='as_fonts/MPLUS1p-Regular.ttf')
    ...
    def show_results(self, wifi_list):
        ...
        for wifi in wifi_list:
            button = SelectableButton(text=wifi, font_size=40,
                                  font_name='as_fonts/MPLUS1p-Regular.ttf', size_hint_y=None, 
                                  selection=self)
...
class WifiPasswordScreen(KeyboardScreen):
    ...
    def password_visibility(self, instance):
        ...
        if not self.keyboard.visibility:
            ...
            self.visibility_button.icon_path = 'as_images/visibility_off.png'
            ...
            self.visibility_button.icon_path = 'as_images/visibility_on.png'
            self.visibility_button.image.source = self.visibility_button.icon_path  
...
class SelectableButton(Button):
    ...
    def __init__(self, text, selection, **kwargs):
        ...
        self.selected = (selection.selected_wifi == text)
        ...
        self.bind(texture_size=self._update_height)  # <-- Add this line
    ...
    def _update_separator(self, *args):
        # Position separator at the bottom of the button, thickness 3px
