...
class TimezoneScreen(SafeScreen):
    def __init__(self, **kwargs):
        ...
        self.selected_timezone = load_config('as_config/settings.json', 'v3_json').get('timezone', '')
        self.timezone_list = []
        self.header = HeaderBar(title="timezone", icon_path="as_images/home.png", button_text="home", button_screen="menu2")
        ...
        for tz in ["Singapore (GMT+8)", "Japan (GMT+9)", "Los Angeles (GMT-7)",]:
            button = SelectableButton(text=tz, font_size=40,
                                                font_family='as_fonts/Roboto-Bold.ttf', size_hint_y=None, 
        ...
        self.save_button = TZSaveButton(text = update_text_language("save"), icon_path="as_images/save.png", 
                                     tz_screen=self,
                                     screen_name='menu2',
