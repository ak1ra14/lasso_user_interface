...
from as_utils.as_config_loader import load_config, update_current_page, update_text_language, save_config
from as_utils.as_layout import HeaderBar, SafeScreen
from as_utils.as_icons import ColoredLabel
...
class MonitorScreen(SafeScreen):
    def __init__(self, **kwargs):
        ...
        setting_button = Button(
            background_normal='as_images/settings.png',
            background_down='as_images/settings.png',
            size_hint=(None, None),
            size=(50, 50),
